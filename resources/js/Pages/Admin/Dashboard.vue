            ...
            >
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ props.stats.total_marcas ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ props.stats.total_modelos ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ props.stats.total_motores ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ props.stats.total_partes ?? 0 }}</p>
                    </div>
                </div>
            </div>
        </div>
